...
class PlayerEngine {
    ...
    maxRequests = 64              // total parallel
    maxRequestsPerHost = 15       // ek host par parallel (IMPORTANT for IPTV)
}
        ...
        fun createPlayer(context: Context): ExoPlayer {
            ...
            trackSelector.parameters = trackSelector.buildUponParameters()
               ...
               // .setMaxAudioChannelCount(2)
                //  Yahan humne aapka Audio Offload Disable wala code add kar diya
